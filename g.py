...
app = Flask(__name__)
# تم السماح لجميع المصادر بالوصول لضمان عمل لوحة التحكم من أي مكان
...
def init_db():
    try:
        ...
        cur = conn.cursor()
        cur.execute("CREATE TABLE IF NOT EXISTS projects (id SERIAL PRIMARY KEY, title TEXT NOT NULL, description TEXT, image_url TEXT, tech_stack TEXT DEFAULT 'FullStack');")
